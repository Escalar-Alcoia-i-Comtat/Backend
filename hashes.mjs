...
import {queryData, update, insert} from './db.mjs';
 ...
 */
export const getFileHash = (path) => crypto.createHash('md5').update(fs.readFileSync(path)).digest('hex');
...
export const runHashesRoutine = async () => {
